...
it's pretty easy to pick up the basics of the language. The Dojo-Control webpage 
...
<p>&nbsp;&nbsp;&nbsp; Here are the core goals of the Dojo-Control project:</p>
...
code, Dojo-Control almost exploits itself. My vulnerable apps won't be the most realistic, but 
...
"Reset DB" link in the main menu .</p>
...
<p>2. By the default, Dojo-Control trys to connect to MySQL on the localhost with 
...
loopback address. By default Dojo-Control only allows access from localhost 

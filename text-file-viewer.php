...
?>
	...
	<option value="http://localhost/readingroom/atms">An Overview of ATMs and Information on the Encoding System
	</option>
	<option selected value="http://localhost/readingroom/auditool.txt">Intrusion Detection in Computers by Victor H. Marshall (January 29, 1991)
	</option>
	<option value="http://localhost/readingroom/backdoor.txt">How to Hold Onto UNIX Root Once You Have It
	</option>
	<option value="http://localhost/readingroom/hack1.hac">The Basics of Hacking, by the Knights of Shadow (Intro)
	</option>
	<option value="http://localhost/readingroom/hacking101.hac">HACKING 101 - By Johnny Rotten - Course #1 - Hacking, Telenet, Life
	</option>
	</select></p>
